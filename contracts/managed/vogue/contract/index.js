...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      executeTrade: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(agentId_0).concat(_descriptor_0.toValue(tradeId_0).concat(_descriptor_2.toValue(currentTime_0))),
      ...
      burnVaultBalance: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(agentId_0).concat(_descriptor_0.toValue(burnId_0).concat(_descriptor_2.toValue(withdrawUsdcAmount_0))),
            alignment: _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment()))
          },
          output: undefined,
          publicTranscript: [],
      ...
      unshieldWithdraw: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(agentId_0).concat(_descriptor_2.toValue(amountUsd_0)),
      ...
      fulfillDarkIntent: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`fulfillDarkIntent: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const intentId_0 = args_1[1];
        const fillPriceUsd_0 = args_1[2];
        const currentTime_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('fulfillDarkIntent',
                                     'argument 1 (as invoked from Typescript)',
                                     'vogue.compact line 148 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(intentId_0.buffer instanceof ArrayBuffer && intentId_0.BYTES_PER_ELEMENT === 1 && intentId_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(intentId_0).concat(_descriptor_2.toValue(fillPriceUsd_0).concat(_descriptor_2.toValue(currentTime_0))),
      ...
      refundDarkIntent: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(intentId_0).concat(_descriptor_2.toValue(currentTime_0)),
            alignment: _descriptor_0.alignment().concat(_descriptor_2.alignment())
          },
          output: undefined,
          publicTranscript: [],
  ...
  _commitStrategy_0(context, partialProofData, agentId_0) {
    ...
    const strategyHash_0 = this._persistentHash_1([__compactRuntime.convertFieldToBytes(32,
                                                                                        this._getMaxPositionPct_0(context,
                                                                                                                  partialProofData),
                                                                                        'vogue.compact line 76 char 7'),
                                                   __compactRuntime.convertFieldToBytes(32,
                                                                                        this._getStopLossPct_0(context,
                                                                                                               partialProofData),
                                                                                        'vogue.compact line 77 char 7'),
                                                   __compactRuntime.convertFieldToBytes(32,
                                                                                        this._getStrategyExpiry_0(context,
                                                                                                                  partialProofData),
                                                                                        'vogue.compact line 78 char 7')]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _executeTrade_0(context, partialProofData, agentId_0, tradeId_0, currentTime_0)
  {
    const recomputedHash_0 = this._persistentHash_1([__compactRuntime.convertFieldToBytes(32,
                                                                                          this._getMaxPositionPct_0(context,
                                                                                                                    partialProofData),
                                                                                          'vogue.compact line 88 char 7'),
                                                     __compactRuntime.convertFieldToBytes(32,
                                                                                          this._getStopLossPct_0(context,
                                                                                                                 partialProofData),
                                                                                          'vogue.compact line 89 char 7'),
                                                     __compactRuntime.convertFieldToBytes(32,
                                                                                          this._getStrategyExpiry_0(context,
                                                                                                                    partialProofData),
                                                                                          'vogue.compact line 90 char 7')]);
    ...
    const intentHash_0 = this._persistentHash_2([this._getIntentAsset_0(context,
                                                 ...
                                                 __compactRuntime.convertFieldToBytes(32,
                                                                                      this._getMinFillAmount_0(context,
                                                                                                               partialProofData),
                                                                                      'vogue.compact line 137 char 7'),
                                                 __compactRuntime.convertFieldToBytes(32,
                                                                                      this._getMaxPriceLimit_0(context,
                                                                                                               partialProofData),
                                                                                      'vogue.compact line 138 char 7'),
                                                 __compactRuntime.convertFieldToBytes(32,
                                                                                      this._getIntentExpiry_0(context,
                                                                                                              partialProofData),
                                                                                      'vogue.compact line 139 char 7')]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                       ...
                       currentTime_0)
  {
    ...
    const recomputedIntentHash_0 = this._persistentHash_2([this._getIntentAsset_0(context,
                                                           ...
                                                           __compactRuntime.convertFieldToBytes(32,
                                                                                                this._getMinFillAmount_0(context,
                                                                                                                         partialProofData),
                                                                                                'vogue.compact line 156 char 7'),
                                                           __compactRuntime.convertFieldToBytes(32,
                                                                                                this._getMaxPriceLimit_0(context,
                                                                                                                         partialProofData),
                                                                                                'vogue.compact line 157 char 7'),
                                                           __compactRuntime.convertFieldToBytes(32,
                                                                                                this._getIntentExpiry_0(context,
                                                                                                                        partialProofData),
                                                                                                'vogue.compact line 158 char 7')]);
