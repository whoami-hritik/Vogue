...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      registerAuthorizedSolver: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`registerAuthorizedSolver: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const solverId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerAuthorizedSolver',
                                     'argument 1 (as invoked from Typescript)',
                                     'vogue.compact line 135 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(solverId_0),
            alignment: _descriptor_0.alignment()
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this._registerAuthorizedSolver_0(context,
                                                          partialProofData,
                                                          solverId_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
    ...
    this.impureCircuits = {
      ...
      registerAuthorizedSolver: this.circuits.registerAuthorizedSolver,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('registerAuthorizedSolver', new __compactRuntime.ContractOperation());
  ...
  _commitStrategy_0(context, partialProofData, agentId_0) {
    const callerId_0 = this._persistentHash_0([this._localSecretKey_0(context,
                                                                      partialProofData),
                                               agentId_0]);
    const strategyHash_0 = this._persistentHash_1([__compactRuntime.convertFieldToBytes(32,
                                                                                        this._getMaxPositionPct_0(context,
                                                                                                                  partialProofData),
                                                                                        'vogue.compact line 71 char 7'),
                                                   __compactRuntime.convertFieldToBytes(32,
                                                                                        this._getStopLossPct_0(context,
                                                                                                               partialProofData),
                                                                                        'vogue.compact line 72 char 7'),
                                                   __compactRuntime.convertFieldToBytes(32,
                                                                                        this._getStrategyExpiry_0(context,
                                                                                                                  partialProofData),
                                                                                        'vogue.compact line 73 char 7')]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _executeTrade_0(context, partialProofData, agentId_0, tradeId_0, currentTime_0)
  {
    ...
    __compactRuntime.assert(this._equal_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                          ...
                                          callerId_0),
                            'unauthorized caller for strategy');
    ...
    const tradeNullifier_0 = this._persistentHash_0([this._localSecretKey_0(context,
                                                                            partialProofData),
                                                     tradeId_0]);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_2.toValue(3n),
                                                                                                                   alignment: _descriptor_2.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(tradeNullifier_0),
                                                                                                                                               alignment: _descriptor_0.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'trade nullifier already spent');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const recomputedHash_0 = this._persistentHash_1([__compactRuntime.convertFieldToBytes(32,
                                                                                          this._getMaxPositionPct_0(context,
                                                                                                                    partialProofData),
                                                                                          'vogue.compact line 95 char 7'),
                                                     __compactRuntime.convertFieldToBytes(32,
                                                                                          this._getStopLossPct_0(context,
                                                                                                                 partialProofData),
  ...
  _registerAuthorizedSolver_0(context, partialProofData, solverId_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _commitDarkIntent_0(context, partialProofData, agentId_0, intentId_0) {
    ...
    const intentHash_0 = this._persistentHash_2([this._getIntentAsset_0(context,
                                                                        partialProofData),
                                                 __compactRuntime.convertFieldToBytes(32,
                                                                                      this._getMinFillAmount_0(context,
                                                                                                               partialProofData),
                                                                                      'vogue.compact line 147 char 7'),
                                                 __compactRuntime.convertFieldToBytes(32,
                                                                                      this._getMaxPriceLimit_0(context,
                                                                                                               partialProofData),
                                                                                      'vogue.compact line 148 char 7'),
                                                 __compactRuntime.convertFieldToBytes(32,
                                                                                      this._getIntentExpiry_0(context,
                                                                                                              partialProofData),
                                                                                      'vogue.compact line 149 char 7')]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                       ...
                       currentTime_0)
  {
    ...
    const recomputedIntentHash_0 = this._persistentHash_2([this._getIntentAsset_0(context,
                                                                                  partialProofData),
                                                           __compactRuntime.convertFieldToBytes(32,
                                                                                                this._getMinFillAmount_0(context,
                                                                                                                         partialProofData),
                                                                                                'vogue.compact line 167 char 7'),
                                                           __compactRuntime.convertFieldToBytes(32,
                                                                                                this._getMaxPriceLimit_0(context,
                                                                                                                         partialProofData),
                                                                                                'vogue.compact line 168 char 7'),
                                                           __compactRuntime.convertFieldToBytes(32,
                                                                                                this._getIntentExpiry_0(context,
                                                                                                                        partialProofData),
                                                                                                'vogue.compact line 169 char 7')]);
